...
if(interestRateField)interestRateField.addEventListener("change", (e) => calculateEmiAmount());
if(loanPeriodField)loanPeriodField.addEventListener("change", (e) => calculateEmiAmount());
if(loanStartDateField)loanStartDateField.addEventListener("change", (e) => calculateEmiAmount());
...
function isNotEmpty(field) {
  if(field) return field.value != undefined && field.value != null && field.value != "";
